...
// These functions are ignored because they are not marked as `pub`: `add_fonts`, `collect_package_specs`, `map_diagnostic`, `map_errors`, `new`, `pre_resolve_packages`, `resolve_package_file`, `resolve_package`, `resolve_span`, `set_allow_packages`, `set_files`, `set_inputs`, `set_markup`, `set_sys_time`, `try_parse_package_spec`
