    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = Ok::<_, ()>(crate::api::typst::CompiledDocument::page_count(
                    &*api_that_guard,
                ))?;
                std::result::Result::Ok(output_ok)
            })())
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = Ok::<_, ()>(crate::api::typst::CompiledDocument::warnings(
                    &*api_that_guard,
                ))?;
                std::result::Result::Ok(output_ok)
            })())
...
fn wire__crate__api__typst__TypstEngine_new_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Ok::<_, ()>(crate::api::typst::TypstEngine::new())?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__typst__get_typst_version_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Ok::<_, ()>(crate::api::typst::get_typst_version())?;
                std::result::Result::Ok(output_ok)
            })())
        },
    )
