...
Abstractions for loading custom assets into the compiler. Note that the compiler already bundles essential fonts (`Libertinus Serif`, `DejaVu Sans Mono`, and `NewCM Math`) by default.
